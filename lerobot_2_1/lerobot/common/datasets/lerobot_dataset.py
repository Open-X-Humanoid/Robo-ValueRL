...
class LeRobotDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        # Check timestamps (np.asarray: compatible with HF datasets 4.x Column / Arrow columns)
        timestamps = np.asarray(self.hf_dataset["timestamp"])
        episode_indices = np.asarray(self.hf_dataset["episode_index"])
