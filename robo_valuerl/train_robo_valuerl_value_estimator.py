...
def main_worker(local_rank=None, world_size=None, is_ddp=False):
    ...
    combined_dataset = ConcatDataset([offline_wrapper, other_wrapper, openx_wrapper])  

    # sampler = create_sampler_for_dataset(
    #     combined_dataset,
    #     weights=[1, config.filtered_weight, config.filtered_weight],
