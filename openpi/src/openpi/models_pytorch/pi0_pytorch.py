...
class PI0Pytorch(nn.Module):
    def __init__(self, config):
        ...
        self.return_to_go_proj = nn.Linear(action_expert_config.width, 1)
    ...
    def forward(self, observation, actions, noise=None, time=None) -> Tensor:
        ...
        # print("prefix_embs shape is:", prefix_embs.shape)
        # print("suffix_embs shape is:", suffix_embs.shape)
        ...
        return action_loss, torch.tensor(0.0)
